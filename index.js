...
console.log(color('\n🚀 viggotarasov ','silver'))
console.log(color('🚀 GITHUB: VIGGO ','silver'))
console.log(color('🚀 WA NUMBER: +51931263982 ','Ⓥⓘⓖⓖⓞ'))
...
└┬❖ 「 @${xeonName.split("@")[0]}  」
   ...
   //you fail to put, i sue you for sure!
let buttons = [
{buttonId: `wkwkwk`, buttonText: {displayText: 'ojala nunca vuelvas y te vuelvas gay de por vida🫠'}, type: 1}
]
let buttonMessage = {
document: fs.readFileSync('./XeonMedia/theme/cheems.xlsx'),
mimetype: docs,
