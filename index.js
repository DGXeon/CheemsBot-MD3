...
console.log(color('\n🐶 YT CHANNEL: MOD GAME ','silver'))
console.log(color('🐶 GITHUB: Andy-GG3 ','silver'))
console.log(color('🐶 WA NUMBER: +6285784902529 ','silver'))
console.log(color('  Andy Bot Inc. 2022','mediumseagreen'))
    ...
    console.log(color('🐶', 'cyan'), color('https://wa.me/6285784902529'))
